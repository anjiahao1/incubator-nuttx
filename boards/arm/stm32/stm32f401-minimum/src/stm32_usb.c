/****************************************************************************
 * boards/arm/stm32/stm32f401-minimum/src/stm32_usb.c
 *
...
#ifndef CONFIG_STM32F401MINIMUM_USBHOST_PRIO
#  define CONFIG_STM32F401MINIMUM_USBHOST_PRIO 100
#endif

#ifndef CONFIG_STM32F401MINIMUM_USBHOST_STACKSIZE
#  define CONFIG_STM32F401MINIMUM_USBHOST_STACKSIZE 1024
#endif
 ...
 *   USB-related GPIO pins for the STM32F401 Discovery board.
 *
 ****************************************************************************/
  ...
  if (g_usbconn)
    {
      ...
      ret = kthread_create("usbhost", CONFIG_STM32F401MINIMUM_USBHOST_PRIO,
                           CONFIG_STM32F401MINIMUM_USBHOST_STACKSIZE,
                           usbhost_waiter, NULL);
